    ...
    >
      ...
      <div className="flex flex-col items-center md:items-start w-full max-w-[450px] relative z-10 animate-in fade-in slide-in-from-right-10 duration-700">
        ...
        <div className="glass w-full p-8 md:p-10 flex flex-col items-center md:items-start">
          <h1 className="gradient-text text-4xl mb-2">Create Account</h1>
          <p className="text-slate-300 mb-8">Join our real-time community</p>
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-5">
          <div>
            <label className="block text-slate-400 text-sm mb-2 px-1">Full Name</label>
          ...
          <div>
            <label className="block text-slate-400 text-sm mb-2 px-1">Password</label>
            <div className="relative group">
